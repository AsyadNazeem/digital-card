...
//             <!-- Add globe SVG icon here -->
//             <svg v-if="locale === 'en'" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
//                 <circle cx="12" cy="12" r="10"/>
//                 <path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/>
//             </svg>
//             <span v-if="locale === 'en'">AR</span>
//             <span v-else>EN</span>
//         </button>
//
