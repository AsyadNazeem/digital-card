<template>
  <div class="action-buttons">
    ...
    <a
        @click.prevent="handlers.handlePhoneClick(contacts[0].cardMobileNum)"
    ...
    <a
        @click.prevent="handlers.handleWhatsAppClick()"
    ...
    <a
        @click.prevent="handlers.handleEmailClick(contacts[0].email)"
    ...
    <a
        @click.prevent="handlers.handleOfficePhoneClick(contacts[0].telephone)"
        class="action-btn office-phone"
    >
      <span v-html="getIcon('phone-office')" class="action-icon"></span>
      <span>{{ handlers.t('office') }}</span>
    </a>

    <a
        @click.prevent="handlers.handleWebsiteClick(company.website)"
        class="action-btn website"
    >
    ...
    <a
        @click.prevent="handlers.handleLocationClick(company.googleLocation)"
        class="action-btn maps"
    >
...
const getIcon = (name) => {
  ...
  return icons[name] || icons.phone_mobile;
};
</script>
